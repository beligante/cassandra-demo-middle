...
import almeida.rochalabs.demo.api.requests.RatePhotoRequest;
import almeida.rochalabs.demo.api.responses.CreatePhotoResponse;
import almeida.rochalabs.demo.api.responses.RatePhotoResponse;
import almeida.rochalabs.demo.data.accessor.PhotosAccessor;
import almeida.rochalabs.demo.data.entities.LatestPhotos;
import almeida.rochalabs.demo.data.entities.Photo;
import almeida.rochalabs.demo.data.entities.PhotoLookupByRank;
import almeida.rochalabs.demo.data.entities.PhotosLookupByUserID;
import almeida.rochalabs.demo.data.entities.Thumbnail;
import almeida.rochalabs.demo.data.query.PhotoQuery;
